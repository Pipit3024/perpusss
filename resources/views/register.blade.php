    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card shadow-lg" style="border-radius: 15px;">
                <div class="card-header text-center" style="background-color: #007bff; color: #fff; border-top-left-radius: 15px; border-top-right-radius: 15px;">
                ...
                <div class="card-footer text-center" style="background-color: #f9f9f9; border-bottom-left-radius: 15px; border-bottom-right-radius: 15px;">
                    <p>Sudah punya akun? <a href="{{ route('login') }}" style="color: #007bff;">Masuk di sini</a></p>
                </div>
            </div>
        </div>
    </div>
