...
<style>
    ...
    .table-primary {
        background-color: #cce5ff; /* Header tabel cerah */
        color: #004085; /* Teks header tabel */
    }

    .btn-warning {
        background-color: #ffc107; /* Tombol tambah barang cerah */
        border: none;
    }

    .btn-warning:hover {
        background-color: #e0a800; /* Hover tombol tambah */
    }
    ...
    .btn-success:hover {
        background-color: #218838; /* Hover tombol edit */
    }

    .btn-primary {
        background-color: #007bff; /* Tombol login cerah */
        border: none;
    }

    .btn-primary:hover {
        background-color: #0069d9; /* Hover tombol login */
    }
</style>
@endsection
